...
main = hspec $ do
  ...
  describe "AOC Day 5" $ do
    describe "Part 1 runProgram function" $ do
      it "can return nothing" $ do
        Day5.runProgram 1 [99] `shouldBe` []
        Day5.runProgram 1 [99, 0, 0, 0, 1, 0, 0, 0] `shouldBe` []
        Day5.runProgram 1 [] `shouldBe` []
      it "can add and output" $ do
        Day5.runProgram 1 [1, 0, 0, 0, 4, 0, 99] `shouldBe` [2]
        Day5.runProgram 1 [1101, 2, 2, 0, 4, 0, 99] `shouldBe` [4]
        Day5.runProgram 1 [1101, 100, -1, 0, 4, 0, 99] `shouldBe` [99]
      it "can multiply and output" $ do
        Day5.runProgram 1 [2, 0, 0, 0, 4, 0, 99] `shouldBe` [4]
        Day5.runProgram 1 [0002, 0, 0, 0, 4, 0, 99] `shouldBe` [4]
        Day5.runProgram 1 [1102, 4, 4, 0, 4, 0, 99] `shouldBe` [16]
      it "can output immediate values"
        $          Day5.runProgram 1 [104, 7, 99]
        `shouldBe` [7]
    describe "Part 2 runProgram function" $ do
      it "compares input is equal to 8 using position mode." $ do
        let program = [3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8]
        Day5.runProgram 7 program `shouldBe` [0]
        Day5.runProgram 2 program `shouldBe` [0]
        Day5.runProgram 8 program `shouldBe` [1]
      it "compares input is less than 8 using position mode." $ do
        let program = [3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8]
        Day5.runProgram 7 program `shouldBe` [1]
        Day5.runProgram 1 program `shouldBe` [1]
        Day5.runProgram 8 program `shouldBe` [0]
        Day5.runProgram 10 program `shouldBe` [0]
      ...
      it "tests jump using position mode" $ do
        ...
        Day5.runProgram 1 program `shouldBe` [1]
        Day5.runProgram 0 program `shouldBe` [0]
      it "tests jump using immediate mode" $ do
        -- | outputs 0 if input was 0 and 1 if input was non-zero
        let program = [3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1]
        Day5.runProgram 123 program `shouldBe` [1]
        Day5.runProgram 0 program `shouldBe` [0]
      it "tests longer program" $ do
        ...
        Day5.runProgram 8 program `shouldBe` [1000]
        Day5.runProgram 800 program `shouldBe` [1001]
